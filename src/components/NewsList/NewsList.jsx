...
import alpha from "../../assets/dnb-alpha.png";
...
export const NewsList = () => {
  let news = [
    ...
    },
    {
      ...
      ingress:
        "The latest surge in U.S. consumer prices is the strongest blow yet to views inflation is transitory, sharpening the",
    ...
    },
    {
      ...
      ingress:
        "The European Central Bank could stop buying bonds as early as next September if inflation looks to have sustainably",
    ...
    },
    {
      ...
      ingress:
        "The Tesla CEO sold around 4.5 million shares in total over the three days, shrinking the size of his stockholdings in the company even after exercising stock options.",
      ...
      <Tabs
        data={{
          ...
          second: {
            ...
            // See Example Content below
            content: (
              <PictureComponent image={macro} height="230px" width="430px" />
            ),
          },
          third: {
            title: "DNB Alpha",
            // See Example Content below
            content: (
              <PictureComponent image={alpha} height="230px" width="430px" />
            ),
          },
        }}
      />
